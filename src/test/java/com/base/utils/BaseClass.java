...
import com.aventstack.extentreports.reporter.ExtentSparkReporter;
	...
	public class BaseClass {
		...
		public static ExtentSparkReporter reporter; //Create html report file
		public static ExtentReports extent; //Update html report file
		public static ExtentTest test; //Status update like pass, fail, info or warning
		
		@BeforeSuite
		public static void report() {
			reporter = new ExtentSparkReporter("./target/ConfirmationextentReports.html");
		...
		public static void reportStatus(String status, String description) throws Throwable {
			switch(status) {
			case "PASS":
			...
			case "PASS SCREENSHOT":
				test.pass(description, MediaEntityBuilder.createScreenCaptureFromPath(addScrnshot())
						.build());
				break;
			}
		}

		public static synchronized String addScrnshot() throws Exception {
			
			Long l = Calendar.getInstance().getTimeInMillis();
			String screenshotId = l.toString();
			String path = System.getProperty("user.dir")+"/target/HotelScreenshots/";
			
			File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			String imgName = path+screenshotId+".png";
			
			File dest = new File(imgName);
			FileHandler.copy(screenshot, dest);
			
			String imgPath = "../target/HotelScreenshots/"+screenshotId+".png";
			return imgPath;
		}
